        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-12">
            <div className="flex justify-center items-center space-x-8 mb-8">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-500">Total Museums</div>
              </div>
              <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {featured.map((museum) => (
              <div
                key={museum.name}
                className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-purple-100 hover:border-purple-200"
              >
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    {museum.city || museum.county || "Location TBD"}
                  </p>
                  {museum.website && (
                    <Link
                      href={museum.website}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="order-1 lg:order-2">
                  ...
                  <div className="mt-2 text-sm text-gray-500">
                    {filteredNames.length === 0 ? (
                      <span className="text-red-500">
                        No museums found matching "{searchTerm}"
                      </span>
                    ) : (
                      <span>Found {filteredNames.length} museums</span>
                    )}
                  </div>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {visibleList.map((entry) => (
                  <Link
                    ...
                    className="group"
                  >
                    <div className="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-all duration-200 border border-gray-200 hover:border-purple-300 hover:bg-purple-50">
                      <div className="flex items-center">
                        <Building2 className="w-4 h-4 text-purple-500 mr-3 group-hover:text-purple-600 transition-colors" />
              ...
              {!searchTerm && filteredNames.length > visibleCount && (
                <button
                  className="mt-6 w-full py-3 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-xl hover:from-purple-600 hover:to-indigo-600 transition-all duration-200 shadow-md hover:shadow-lg"
          ...
          <div className="text-center mt-16 pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-500">
              Explore Michigan's cultural heritage through art, history,
              science, and educational exhibits.
            </p>
          </div>
        </div>
      </div>
